      ...
      <div>
        ...
        <div class="container mb-5">
          ...
          <div class="filter-box mt-2 pb-4">
            ...
            <select
              class="form-control selectLocation"
            ...
            />{" "}
            <label for="North_Indian" class="filter-content">
              North Indian
            </label>{" "}
            <br />
            <input
            ...
            />{" "}
            <label for="South_Indian" class="filter-content">
              South Indian
            </label>{" "}
            <br />
            <input
            ...
            />{" "}
            <label for="Chinese" class="filter-content">
              Chinese
            </label>{" "}
            <br />
            <input
            ...
            />{" "}
            <label for="Fast_Food" class="filter-content">
              Fast Food
            </label>{" "}
            <br />
            <input
            ...
            />{" "}
            <label for="Street_Food" class="filter-content">
              Street Food
            </label>{" "}
            <br />
            ...
            />{" "}
            <label for="500" class="filter-content">
              Less than `500
            </label>{" "}
            <br />
            <input
            ...
            />{" "}
            <label for="1000" class="filter-content">
              ` 500 to ` 1000
            </label>{" "}
            <br />
            <input
            ...
            />{" "}
            <label for="1500" class="filter-content">
              ` 1000 to ` 1500
            </label>{" "}
            <br />
            <input
            ...
            />{" "}
            <label for="2000" class="filter-content">
              ` 1500 to ` 2000
            </label>{" "}
            <br />
            <input
            ...
            />
            <label for="ltoh" class="filter-content">
              Price low to high
            </label>{" "}
            <br />
            <input
              ...
              onClick={() => this.handleSort(-1)}
            />
            <label for="htol" class="filter-content">
              Price high to low
            </label>{" "}
            <br />
          </div>
